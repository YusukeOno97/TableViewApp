...
class TableViewController3: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "SportsCell", for: indexPath)

        // Configure the cell...
        cell.textLabel?.text = sports[indexPath.row]
        cell.imageView?.image = UIImage(named: "kubotakehusa")
        return cell
    }
